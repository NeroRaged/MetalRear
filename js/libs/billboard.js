var Bill = function (path,shader_vs,shader_fs){
...
Bill.prototype = {
	...
	draw : function(camara,mvMatrix,light){
		if (this.readyVertex){
			var pos = [];
	...
	drawPlane : function(camara,mv,light){
		if (this.readyVertex){
			var RAD = (Math.PI / 180);
			var mvMatrix = mat4.create();
			
			mat4.translate(mvMatrix, mvMatrix, [mv.px, mv.py, mv.pz]);

			mat4.rotateX(mvMatrix, mvMatrix, RAD * (mv.rx)); /* en radianes */
        	mat4.rotateY(mvMatrix, mvMatrix, RAD * (mv.ry-90) ); /* en   radianes */
        	mat4.rotateZ(mvMatrix, mvMatrix, RAD * (mv.rz+90)); /* en radianes */ 
